...
<body>
    ...
    <c:forEach var="menuVO" items="${menuSvc.all}">
        <c:if test="${menuVO.menu_Status == 1}">
            <form id="menuform" name="shoppingForm" class="shoppingForm" action="ShoppingServlet.do" method="POST">
    ...
    <a href="Cart.jsp"><i class="fas fa-shopping-cart" style="font-size: 40px;"></i></a>
