    ...
    <div class="modal fade" id="couponModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <jsp:useBean id="CouponhSvc" class="com.couponhistory.model.CouponhistoryService" />
                <%
>>>>>>> b210c5b1c43c521a8b22de3b5b36d07cd61f271e
...
=======
                ...
                <%-- 				<c:out value="${CouponhSvc.getCouponByMem(memVO.mem_No)}" --%>
                <%-- 					default="幹沒值!" /> --%>
                <form method="post" action="<%request.getContextPath();%>/front_end/shoppingCart/ShoppingServlet.do">
                    <div class="modal-body">
                        ...
                        <select name="couponName">
                            <c:forEach var="CouponhVO" items="${CouponhSvc.getCouponByMem(memVO.mem_No)}">
                                ...
                                <%--取得優惠卷類別 --%>
                                <option value="${coucat.coucat_Name }">${coucat.coucat_Name }
                                    <%--取得優惠卷類別名稱 --%>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-secondary btn-sm" data-dismiss="modal">使用</button>
