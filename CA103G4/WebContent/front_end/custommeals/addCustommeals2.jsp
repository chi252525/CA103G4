                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div style="width:450px;">
                                                ...
                                                <input class="form-control" type="hidden"  name="mem_No" size="45" value="<%=(memVO==null)?"":memVO.getMem_No()%>" /><br>
                                                <div class="form-inline">
                                                    &nbsp;&nbsp;&nbsp;餐點名稱&nbsp;&nbsp;&nbsp;
                                                    <input type="text" class="form-control custom_Name" size="45" style="margin-top:10px; width:250px;" value="<%=(custommealsVO==null)?"":custommealsVO.getcustom_Name()%>" /><br>
                                                </div>
                                                <div class="form-inline">
                                                    &nbsp;&nbsp;&nbsp;餐點價格&nbsp;&nbsp;&nbsp;
                                                    <input type="text" class="form-control custom_Price" size="45"  readonly style="margin-top:10px; width:250px;" value="<%=(custommealsVO==null)?"":custommealsVO.getcustom_Price()%>" /><br>
                                                </div>
                                                <table>
                                            ...
                                            <div style="width:150px;">
                                                <div class="column-button">
                                                    <button type="button" class="button confirm-button confirmBtn btn btn-light">計算金額</button>
                                                </div>


                                                <div class="column-button">
                                                    <button class="button confirm-button btn btn-light" type="submit" value="ADD" disabled="true">送出新增</button>
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div style="width:150px;">
                                                    ...
                                                    <div class="column-button">
                                                        <button id="new" class="button confirm-button btn btn-light" type="submit" value="ADD" disabled="true">送出新增</button>
                                                        <input type="hidden" name="action" value="insert">
                                                    </div>
                                                </div>
                                            </div>
