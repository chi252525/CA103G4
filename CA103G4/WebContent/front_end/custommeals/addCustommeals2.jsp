                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
											...
											<div class="form-inline">
                                                &nbsp;&nbsp;&nbsp;餐點名稱&nbsp;&nbsp;&nbsp;
                                                <input class="form-control" type="text" name="custom_Name" size="45" style="margin-top:10px; width:250px;" value="<%=(custommealsVO==null)?"":custommealsVO.getcustom_Name()%>" required /><br>
											</div>
											<div class="form-inline">
                                                &nbsp;&nbsp;&nbsp;餐點價格&nbsp;&nbsp;&nbsp;
                                                <input  class="form-control custom_Price" type="text" id="custom_Price" size="45"  readonly style="margin-top:10px; width:250px;" value="<%=(custommealsVO==null)?"":custommealsVO.getcustom_Price()%>" /><br>
											</div>
                                                <table>
                                            ...
                                            <div style="width:150px;">
                                                <div class="column-button">
                                                    <button id='assess' type="button" class="button confirm-button confirmBtn btn btn-light">計算金額</button>
                                                </div>
