...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/<tempu></tempu>sdominus-bootstrap-4/5.0.1/css/tempusdominus-bootstrap-4.min.css" />

    <!-- My <css></css> for transaction page-->
    <link rel="stylesheet" href="branch_css.css">

    <!--google map-->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAVvkoc869SBf34DZpfKfonr5mswbwxoFU&callback=initMap"
    async defer></script>
    <style>
