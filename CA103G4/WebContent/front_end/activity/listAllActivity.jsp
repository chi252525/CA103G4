		...
		<div class="row " style="background-color: rgba(255, 255, 255, 0.45)">
			...
			<div class="my-1 col-12">
				<div class="col-4 px-0">
					...
					<FORM METHOD="post"
						ACTION="<%=request.getContextPath()%>/back_end/activity/activity.do">
									...
									<div class="row"
										...
										<div class=" col-4 px-1 py-1 ">
											<img class="img-fluid d-block mx-auto my-auto"
												src="<%=request.getContextPath()%>/activity/activityshowsmallpic.do?act_No=${actVO.act_No}">
										</div>
													...
													<div class="row">
														...
														<div class="col-4">
															<a class="btn btn-sm btn-danger"
																href="<%=request.getContextPath()%>/couponhistory/CouponhistoryServlet.do?action=insert&mem_No=M000001&coucat_No=${activityVO.coucat_No}"
																onclick="getCoupontrue()">取得優惠卷</a>
			...
			<script type="text/javascript">
			function getCoupontrue() {
                // 				console.log("0000");
                $.ajax({
                    type: "post",
                    url: "<%=request.getContextPath()%>
				/couponhistory/CouponhistoryServlet.do",
								data : {
									"action" : "insert"
								},
								dataType : "text",
								success : function(result) {
									$("#gotCoupon").innerHTML(<p>result<p>);
								},
								error : function() {
									alert("Oops!沒取到優惠券")
								}
