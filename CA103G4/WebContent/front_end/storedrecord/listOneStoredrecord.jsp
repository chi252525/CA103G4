...
<html>
<head>
<title>儲值歷史紀錄 - listOneStoredrecord.jsp</title>
	...
	<table id="table-1">
		<tr>
			<td>
				...
				<h4>
					<a href="select_page.jsp"><img src="images/arrow-back-icon.png"
...
<!-- Timestamp format  -->
		<%
			...
			String fd = df.format(SrVO.getStor_Date());
		%>
		<tr>
