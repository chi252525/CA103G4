...
<html>
<head>
<title>所有儲值紀錄資料 - listAllStoredRecordBymem.jsp</title>
...
<body bgcolor='white'>
	...
	<table>
		...
		<c:forEach var="StoredrecordVO" items="${list}" begin="<%=pageIndex%>"
				...
				<td>
					<FORM METHOD="post" ACTION="storedrecord.do"
						...
						<input type="submit" value="修改"> <input type="hidden"
							name="stor_No" value="${StoredrecordVO.stor_No}"> <input
