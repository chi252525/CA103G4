...
<body>
   <nav class="navbar hd"></nav>
    <nav class="navbar navbar-expand-lg mainbar">
       ...
       <div class="title-box">
        <a class="navbar-brand title" href="<%=request.getContextPath()%>/back_end/HQback_index.jsp">竹風堂</a>
        </div> 
    <!-- 縮起來的3-lines  -->    
    ...
    <!--  -->   
            ...
            <ul class="navbar-nav content">
             ...
             <li class="nav-item dropdown b">
              <c:if test="${mgerVO != null}">
                 <a id="xxx" class="nav-item nav-link p aboutUs nav-link dropdown-toggle" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-file main-icon" aria-hidden="true"></i><c class="icon-font">關於我們資料編輯</c></a>
               </c:if>  
                 </li>
             ...
             <script>
              ...
              <li class="nav-item dropdown b">
               <c:if test="${mgerVO != null}">
                 <a class="nav-item nav-link p branch nav-link dropdown-toggle" id="yyy" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-university main-icon" aria-hidden="true"></i><c class="icon-font">分店管理</c></a>
               </c:if>  
              </li>
              ...
              <li class="nav-item dropdown b">
               	<c:if test="${mgerVO != null}">
                 <a class="nav-item nav-link p activity nav-link dropdown-toggle" id="zzz" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-users main-icon" aria-hidden="true"></i><c class="icon-font">活動管理</c></a>
             	</c:if>
              </li>
              <script>
	            	 $('#zzz').click(function(){
          ...
          <ul class="nav navbar-nav pull-right" style="padding:8px;">
                ...
                <c:if test="${mgerVO != null }">
                <a href="<%=request.getContextPath()%>/HQemplogout.do" class="btn btn-sm  log-in" ><i class="fa fa-user" aria-hidden="true"></i>登出</a>
				</c:if>
<!--
               &nbsp;
